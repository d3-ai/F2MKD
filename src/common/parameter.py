...
def initialize_cv_parameters(parameters: Parameters)-> Parameters:
    tensors = parameters_to_weights(parameters)
    cv_weights = [np.zeros_like(tensor) for tensor in tensors]
    return weights_to_parameters(cv_weights)
