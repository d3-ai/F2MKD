...
class RayClientProxy(ClientProxy):
    ...
    def __init__(self, client_fn: ClientFn, cid: str, resources: Dict[str, int], config: Dict[str, Any]):
        super().__init__(cid)
    ...
    def fit(self, ins: FitIns) -> FitRes:
        ...
        future_fit_res = launch_and_fit.remote(
...
@ray.remote(num_cpus=1) # (num_cpus=1,num_gpus=0.1)  # type: ignore
